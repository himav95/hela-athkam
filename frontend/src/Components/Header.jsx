  ...
  return (
    <>
      ...
      >
        ...
        <Nav>
          <Nav.Link className="mx-auto" onClick={openFormModal}>
            Sign Up
          </Nav.Link>
          <Nav.Link className="mx-auto" onClick={openFormModal}>
            Login
      ...
      >
        <Container>
          ...
          >
            ...
            <Nav.Link className="mx-5" href="/products">
              Products
            </Nav.Link>
            <Nav.Link className="mx-5" href="/services">
              Services
            </Nav.Link>
            <Nav.Link className="mx-5" href="/orderonline">
              Order Online
            </Nav.Link>
            <Nav.Link className="mx-5" href="/contact">
              Contact Us
            </Nav.Link>
            <Nav.Link className="mx-5" href="/joinus">
              Join Us
            </Nav.Link>
          </Nav>
        </Container>
